...
class Setting(models.Model):
    app_name = models.CharField(max_length=255, blank=False, null=False, help_text=_(
        "The name of your application"), verbose_name=_("App name"))
    app_logo = models.ImageField(upload_to="settings/", blank=False, null=False, help_text=_(
        "A 512x512 logo of your application (.png or .jpeg)"), verbose_name=_("App logo"))
    ...
    organization_name = models.CharField(default='WebODM', max_length=255, blank=True, null=True, help_text=_(
        "The name of your organization"), verbose_name=_("Organization name"))
    organization_website = models.URLField(default='https://github.com/OpenDroneMap/WebODM/', max_length=255, blank=True,
                                           null=True, help_text=_("The website URL of your organization"), verbose_name=_("Organization website"))
    ...
    def save(self, *args, **kwargs):
        ...
        if self.__original_app_logo_name != "" and \
            ...
            old_logo_path = os.path.join(
                settings.MEDIA_ROOT, self.__original_app_logo_name)
            ...
            if os.path.exists(old_logo_path_caches):
                try:
                    ...
                    logger.warning("Cannot cleanup {}".format(
                        old_logo_path_caches))
...
def setting_pre_save(sender, instance, **kwargs):
    if Setting.objects.count() > 0 and instance.id != Setting.objects.get().id:
        raise ValidationError(
            "Can only create 1 %s instance" % Setting.__name__)
